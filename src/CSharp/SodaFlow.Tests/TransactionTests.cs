...
public sealed class TransactionTests
{
    ...
    public async Task PostInTransaction()
    {
        ...
        // Captured, and not asserted at that point: Transaction.RunVoid takes an Action, so an
        // no code can await an assertion in it. It starts with a value that the lambda must overwrite,
