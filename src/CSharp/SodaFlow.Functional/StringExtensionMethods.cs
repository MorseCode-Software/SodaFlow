...
namespace SodaFlow.Functional
{
    ...
    public static class StringExtensionMethods
    {
        ...
        {
            DateTime result;
            return DateTime.TryParse(value, provider, styles, out result) ? Maybe.Some(result) : Maybe.None;
        }
        ...
        {
            DateTime result;
            return DateTime.TryParseExact(value, format, provider, styles, out result)
                ? Maybe.Some(result)
                : Maybe.None;
        }
        ...
        {
            DateTimeOffset result;
            return DateTimeOffset.TryParse(value, provider, styles, out result) ? Maybe.Some(result) : Maybe.None;
        }
        ...
        {
            TEnum result;
            return Enum.TryParse(value, out result) ? Maybe.Some(result) : Maybe.None;
        }
        ...
        {
            TEnum result;
            return Enum.TryParse(value, ignoreCase, out result) ? Maybe.Some(result) : Maybe.None;
        }
